...
@section('content')
    ...
    <form action="{{ route('articles.update', $article->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <textarea name="short_description" id="short_description" class="form-control" rows="3" required>{{ old('short_description', $article->short_description) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="content" id="content" class="form-control" rows="8" required>{{ old('content', $article->content) }}</textarea>
            <small class="text-muted">Минимум 20 символов</small>
        </div>

        <div class="mb-3">
            <label for="preview_image" class="form-label">Изображение-превью</label>
            <input type="text" name="preview_image" id="preview_image" class="form-control" placeholder="preview.jpg" value="{{ old('preview_image', $article->preview_image) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="full_image" id="full_image" class="form-control" placeholder="full.jpeg" value="{{ old('full_image', $article->full_image) }}">
            <small class="text-muted">Имя файла из папки public/images/</small>
        </div>
